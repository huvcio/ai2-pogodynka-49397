...
class MeasurementController extends AbstractController
{
    ...
    #[IsGranted('ROLE_MEASURMENT_INDEX')]
    ...
    #[IsGranted('ROLE_MEASURMENT_SHOW')]
    ...
    #[IsGranted('ROLE_MEASURMENT_EDIT')]
    ...
    #[IsGranted('ROLE_MEASURMENT_DELETE')]
